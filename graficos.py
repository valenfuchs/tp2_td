...
plt.plot(list(range(0,27)), dist4, color='green', label = 'Relocate')
plt.plot(list(range(0,27)), dist5, color='purple', label = 'Swap')
...
plt.plot(list(range(0,27)), tiempo4, color='green', label = 'Relocate')
plt.plot(list(range(0,27)), tiempo5, color='purple', label = 'Swap')
...
plt.plot(list(range(0,27)), dist6, color='green', label = 'Relocate')
plt.plot(list(range(0,27)), dist7, color='purple', label = 'Swap')
...
plt.plot(list(range(0,27)), tiempo6, color='green', label = 'Relocate')
plt.plot(list(range(0,27)), tiempo7, color='purple', label = 'Swap')
...
plt.plot(list(range(0,27)), dist8, color='green', label = 'Relocate')
plt.plot(list(range(0,27)), dist9, color='purple', label = 'Swap')
...
plt.plot(list(range(0,27)), tiempo8, color='green', label = 'Relocate')
plt.plot(list(range(0,27)), tiempo9, color='purple', label = 'Swap')
...
plt.plot(list(range(0,27)), dist10, color='green', label = '100 iteraciones')
plt.plot(list(range(0,27)), dist11, color='purple', label = '300 iteraciones')
plt.plot(list(range(0,27)), dist12, color='orange', label = '500 iteraciones')
...
plt.plot(list(range(0,27)), tiempo10, color='green', label = '100 iteraciones')
plt.plot(list(range(0,27)), tiempo11, color='purple', label = '300 iteraciones')
plt.plot(list(range(0,27)), tiempo12, color='orange', label = '500 iteraciones')
